...
(defvar espresso-mode-map
  (let ((keymap (make-sparse-keymap)))
    ...
    (easy-menu-define nil keymap "Espresso Menu"
      '("Javascript"
        ["Select new Mozilla contextâ€¦" espresso-set-js-context
         (fboundp #'inferior-moz-process)]
        ["Evaluate expression in Mozilla contextâ€¦" espresso-js-eval
         (fboundp #'inferior-moz-process)]
        ["Send current function to Mozillaâ€¦" espresso-eval-defun
         (fboundp #'inferior-moz-process)]
        )
      )
