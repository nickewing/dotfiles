...
;;;;;;  "pastie" "pastie.el" (19402 18173))
;;; Generated autoloads from pastie.el

(autoload (quote pastie-region) "pastie" "\
...
(autoload (quote pastie-buffer) "pastie" "\
...
(autoload (quote pastie-get) "pastie" "\
Fetch the contents of the paste from pastie.org into a new buffer.

\(fn ID)" t nil)

(autoload (quote pastie-browse) "pastie" "\
Not documented
...
;;;***

;;;### (autoloads nil nil ("pastie-pkg.el") (19402 18173 374194))
